    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull final Result result) {
        switch (call.method) {
            ...
            case "setExposureTime": {
                try {
                    camera.setExposureTime(result, ((Number) call.argument("exposureTime")).longValue());
                } catch (Exception e) {
                    handleException(e, result);
                }
                break;
            ...
            case "availableLensApertures": {
                try {
                    result.success(camera.getAvailableLensApertures());
                } catch (Exception e) {
                    handleException(e, result);
                }
                break;
            ...
            case "getLensAperture": {
                try {
                    result.success(camera.getLensAperture());
                } catch (Exception e) {
                    handleException(e, result);
                }
                break;
            ...
            case "setLensAperture": {
                try {
                    camera.setLensAperture(result, call.argument("lensAperture"));
                } catch (Exception e) {
                    handleException(e, result);
                }
                break;
            ...
            case "getMaxSensorSensitivity": {
                try {
                    result.success(camera.getMaxSensorSensitivity());
                } catch (Exception e) {
                    handleException(e, result);
                }
                break;
            ...
            case "getMinSensorSensitivity": {
                try {
                    result.success(camera.getMinSensorSensitivity());
                } catch (Exception e) {
                    handleException(e, result);
                }
                break;
            ...
            case "setSensorSensitivity": {
                try {
                    camera.setSensorSensitivity(result, call.argument("sensorSensitivity"));
                } catch (Exception e) {
                    handleException(e, result);
                }
                break;
