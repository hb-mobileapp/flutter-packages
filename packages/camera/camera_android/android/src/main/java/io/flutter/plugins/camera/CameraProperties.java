...
public interface CameraProperties {
    ...
    /**
     * Returns the maximum and minimum exposure time values
     *
     * <p>By default maps to the @see
     * android.hardware.camera2.CameraCharacteristics#SENSOR_INFO_SENSITIVITY_RANGE key.
     *
     * @return android.util.Range<Integer> maximum and minimum exposure time supported by this
     * camera device.
     */
    ...
    /**
     * Returns a list of available lens aperture for @see android.control.afMode that are supported by this
     * camera device.
     *
     * <p>By default maps to the @see
     * android.hardware.camera2.CameraCharacteristics#CONTROL_AF_AVAILABLE_MODES key.
     *
     * @return Float[] List of lens apertures supported by this camera device.
     */
    ...
    /**
     * Returns the maximum and minimum iso values
     *
     * <p>By default maps to the @see
     * android.hardware.camera2.CameraCharacteristics#SENSOR_INFO_EXPOSURE_TIME_RANGE key.
     *
     * @return android.util.Range<Integer> Maximum and minimum exposure sensor sensitivity supported by this
     * camera device.
     */
