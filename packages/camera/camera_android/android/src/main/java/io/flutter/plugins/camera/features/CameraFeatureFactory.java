...
public interface CameraFeatureFactory {
    ...
    /**
     * Creates a new instance of the lens aperture feature.
     *
     * @param cameraProperties instance of the CameraProperties class containing information about the
     *                         cameras features.
     * @return newly created instance of the LensApertureFeature class.
     */
    LensApertureFeature createLensApertureFeature(@NonNull CameraProperties cameraProperties);
    ...
    /**
     * Creates a new instance of the sensor sensitivity feature.
     *
     * @param cameraProperties instance of the CameraProperties class containing information about the
     *                         cameras features.
     * @return newly created instance of the SensorSensitivityFeature class.
     */
    SensorSensitivityFeature createSensorSensitivityFeature(@NonNull CameraProperties cameraProperties);
    ...
    /**
     * Creates a new instance of the exposure time feature.
     *
     * @param cameraProperties instance of the CameraProperties class containing information about the
     *                         cameras features.
     * @return newly created instance of the ExposureTimeFeature class.
     */
    ExposureTimeFeature createExposureTimeFeature(@NonNull CameraProperties cameraProperties);
