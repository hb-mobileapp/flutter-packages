...
public class CameraFeatures {
    ...
    private static final String LENS_APERTURE = "LENS_APERTURE";
    ...
    private static final String SENSOR_SENSITIVITY = "SENSOR_SENSITIVITY";
    ...
    public static CameraFeatures init(
        ...
        cameraFeatures.setExposureTime(cameraFeatureFactory.createExposureTimeFeature(cameraProperties));
    ...
    /**
     * Gets the exposure time feature if it has been set.
     *
     * @return the exposure time feature.
     */
    public ExposureTimeFeature getExposureTime(){
        return (ExposureTimeFeature) featureMap.get(EXPOSURE_TIME);
    }

    /**
     * Sets the instance of the exposure time feature.
     *
     * @param exposureTime the {@link ExposureTimeFeature} instance to set.
     */
    public void setExposureTime(ExposureTimeFeature exposureTime){
        this.featureMap.put(EXPOSURE_TIME, exposureTime);
    }
    ...
    /**
     * Gets the lens aperture feature if it has been set.
     *
     * @return the lens aperture feature.
     */
    public LensApertureFeature getLensAperture(){
        return (LensApertureFeature) featureMap.get(LENS_APERTURE);
    }

    /**
     * Sets the instance of the lens aperture feature.
     *
     * @param lensAperture the {@link LensApertureFeature} instance to set.
     */
    public void setLensAperture(LensApertureFeature lensAperture){
        this.featureMap.put(LENS_APERTURE, lensAperture);
    }
    ...
    /**
     * Gets the sensor sensitivity feature if it has been set.
     *
     * @return the sensor sensitivity feature.
     */
    public SensorSensitivityFeature getSensorSensitivity(){
        return (SensorSensitivityFeature) featureMap.get(SENSOR_SENSITIVITY);
    }

    /**
     * Sets the instance of the sensor sensitivity feature.
     *
     * @param sensorSensitivity the {@link SensorSensitivityFeature} instance to set.
     */
    public void setSensorSensitivity(SensorSensitivityFeature sensorSensitivity){
        this.featureMap.put(SENSOR_SENSITIVITY, sensorSensitivity);
    }
